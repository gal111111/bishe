...
.stMetric {
    background: linear-gradient(135deg, rgba(15, 15, 26, 0.9) 0%, rgba(30, 30, 50, 0.9) 100%);
    border-radius: 20px;
    padding: 24px;
...
def show_dashboard(df):
    ...
    with col_title:
        ...
        &lt;div class="main-header"&gt;
            &lt;div style="display: flex; align-items: center; gap: 24px; position: relative; z-index: 1;"&gt;
                &lt;div style="font-size: 64px;" class="floating-icon"&gt;🎯&lt;/div&gt;
                &lt;div&gt;
                    &lt;h1 style="margin: 0; font-size: 36px; font-weight: 800;" class="glow-text"&gt;城市舆情态势感知中心&lt;/h1&gt;
                    &lt;p style="margin: 8px 0 0 0; color: rgba(148, 163, 184, 0.9); font-size: 16px;"&gt;实时监控城市公共设施服务质量与市民满意度&lt;/p&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
        """, unsafe_allow_html=True)
    with col_time:
        ...
        if 'platform' in df.columns:
            st.caption(f"数据来源: {df['platform'].nunique()}个平台")
    ...
    with c4:
        ...
        &lt;div class="stat-card"&gt;
            &lt;h3&gt;正面评价&lt;/h3&gt;
            &lt;div class="value" style="background: linear-gradient(135deg, #22c55e, #16a34a); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"&gt;{pos_rate:.1f}%&lt;/div&gt;
    ...
    with c5:
        ...
        &lt;div class="stat-card"&gt;
            &lt;h3&gt;中性评价&lt;/h3&gt;
            &lt;div class="value" style="background: linear-gradient(135deg, #f59e0b, #d97706); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"&gt;{neu_rate:.1f}%&lt;/div&gt;
    ...
    with c6:
        ...
        &lt;div class="stat-card"&gt;
            &lt;h3&gt;负面评价&lt;/h3&gt;
            &lt;div class="value" style="background: linear-gradient(135deg, #ef4444, #dc2626); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"&gt;{neg_rate:.1f}%&lt;/div&gt;
            ...
            with st.container():
                ...
                if 'polarity_label' in df.columns:
                    ...
                    fig = px.pie(
                        ...
                        hole=0.4,
                        color_discrete_map={'积极': '#22c55e', '中性': '#f59e0b', '消极': '#ef4444'},
                        title='情感倾向占比'
                    )
                    fig.update_layout(
...
def page_data_center():
    ...
    &lt;div class="main-header"&gt;
        &lt;div style="position: relative; z-index: 1;"&gt;
            &lt;h1 style="margin: 0; font-size: 32px; font-weight: 800;"&gt;📁 数据管理中心&lt;/h1&gt;
            &lt;p style="margin: 8px 0 0 0; color: rgba(148, 163, 184, 0.9);"&gt;在这里管理原始数据，并启动核心分析引擎。&lt;/p&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    """, unsafe_allow_html=True)
...
def page_chatbot():
    ...
    &lt;div class="main-header"&gt;
        &lt;div style="position: relative; z-index: 1;"&gt;
            &lt;h1 style="margin: 0; font-size: 32px; font-weight: 800;"&gt;🤖 智能决策助手 (RAG)&lt;/h1&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    """, unsafe_allow_html=True)
...
def page_report():
    ...
    &lt;div class="main-header"&gt;
        &lt;div style="position: relative; z-index: 1;"&gt;
            ...
            &lt;p style="margin: 8px 0 0 0; color: rgba(148, 163, 184, 0.9);"&gt;一键导出完整分析报告，支持多种格式下载&lt;/p&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    """, unsafe_allow_html=True)
    ...
    if not md_files:
        st.markdown("""
        &lt;div style="text-align: center; padding: 60px 20px; background: rgba(15, 15, 26, 0.6); border-radius: 24px; border: 1px solid rgba(99, 102, 241, 0.2);"&gt;
            &lt;div style="font-size: 64px; margin-bottom: 16px;"&gt;📭&lt;/div&gt;
            &lt;h3 style="color: rgba(148, 163, 184, 0.9);"&gt;暂无生成的报告&lt;/h3&gt;
            &lt;p style="color: rgba(107, 114, 128, 0.9);"&gt;请先在【数据中心】运行分析，系统将自动生成学术报告&lt;/p&gt;
        &lt;/div&gt;
        """, unsafe_allow_html=True)
        return
    ...
    with tab1:
        ...
        with col_left:
            st.markdown(f"""
            &lt;div class="card"&gt;
                &lt;h3 style="margin: 0 0 20px 0; color: #ffffff;"&gt;📋 报告信息&lt;/h3&gt;
                &lt;p style="color: rgba(148, 163, 184, 0.9); margin: 8px 0;"&gt;&lt;b&gt;文件名:&lt;/b&gt; {report_name}&lt;/p&gt;
                &lt;p style="color: rgba(148, 163, 184, 0.9); margin: 8px 0;"&gt;&lt;b&gt;生成时间:&lt;/b&gt; {time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(os.path.getmtime(latest_md)))}&lt;/p&gt;
                &lt;p style="color: rgba(148, 163, 184, 0.9); margin: 8px 0;"&gt;&lt;b&gt;文件大小:&lt;/b&gt; {os.path.getsize(latest_md)/1024:.1f} KB&lt;/p&gt;
                &lt;p style="color: rgba(148, 163, 184, 0.9); margin: 8px 0;"&gt;&lt;b&gt;历史报告:&lt;/b&gt; {len(md_files)} 份&lt;/p&gt;
            &lt;/div&gt;
            """, unsafe_allow_html=True)
        ...
        with col_right:
            st.markdown("""
            &lt;div class="card"&gt;
                &lt;h3 style="margin: 0 0 20px 0; color: #ffffff;"&gt;📈 报告内容&lt;/h3&gt;
                &lt;p style="color: #22c55e; margin: 8px 0;"&gt;✅ 执行摘要&lt;/p&gt;
                &lt;p style="color: #22c55e; margin: 8px 0;"&gt;✅ 数据采集概况&lt;/p&gt;
                &lt;p style="color: #22c55e; margin: 8px 0;"&gt;✅ 情感分析深度解析&lt;/p&gt;
                &lt;p style="color: #22c55e; margin: 8px 0;"&gt;✅ 方面级满意度分析&lt;/p&gt;
                &lt;p style="color: #22c55e; margin: 8px 0;"&gt;✅ 改进建议与对策&lt;/p&gt;
            &lt;/div&gt;
            """, unsafe_allow_html=True)
    ...
    with tab3:
        ...
        with col_dl1:
            st.markdown("""
            &lt;div style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); border-radius: 16px; padding: 24px; text-align: center; margin-bottom: 16px;"&gt;
        ...
        with col_dl2:
            st.markdown("""
            &lt;div style="background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); border-radius: 16px; padding: 24px; text-align: center; margin-bottom: 16px;"&gt;
                &lt;div style="font-size: 48px; margin-bottom: 8px;"&gt;📊&lt;/div&gt;
        ...
        with col_dl3:
            st.markdown("""
            &lt;div style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border-radius: 16px; padding: 24px; text-align: center; margin-bottom: 16px;"&gt;
...
def main():
    ...
    with st.sidebar:
        ...
        &lt;div class="sidebar-logo"&gt;
            &lt;div style="font-size: 72px;" class="floating-icon"&gt;🎯&lt;/div&gt;
            &lt;h2 style="margin: 0; font-size: 24px; font-weight: 800; background: linear-gradient(135deg, #6366f1, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"&gt;城市慧眼 3.0&lt;/h2&gt;
            &lt;p style="margin: 8px 0 0 0; color: rgba(148, 163, 184, 0.8); font-size: 13px;"&gt;城市公共设施舆情分析系统&lt;/p&gt;
        &lt;/div&gt;
        """, unsafe_allow_html=True)
