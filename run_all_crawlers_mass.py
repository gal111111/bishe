...
def run_zhihu_crawler(keyword="上海迪士尼", target_count=100):
    """运行知乎爬虫"""
    print("\n" + "=" * 80)
    print("开始运行知乎爬虫")
    print("=" * 80)
...
def run_tieba_crawler(keyword="上海迪士尼", target_count=100):
    """运行贴吧爬虫"""
    print("\n" + "=" * 80)
    print("开始运行贴吧爬虫")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    print(f"预计获取评论数: 每个帖子约25条评论，总计约10000条评论\n")
