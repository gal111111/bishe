...
class TiebaSpider:
    ...
    def _handle_login(self):
        ...
        if os.path.exists(self.cookie_path):
            try:
                import json
                self.driver.get("https://tieba.baidu.com/404")
                time.sleep(1)
                ...
                if "tieba.baidu.com" in self.driver.current_url:
                    print("使用已保存的 Cookie 登录成功！无需扫码！")
                    return True
            except Exception as e:
                print("Cookie加载失败: %s" % str(e))
        
        print("本地Cookie无效/未找到，请在浏览器中登录贴吧")
    ...
    def crawl(self, keyword, target_count=20):
        ...
        try:
            search_url = "https://tieba.baidu.com/f?kw=%s" % keyword
